...
const CategoryCard = (props: any) => {
    return (
        ...
        hover:bg-gray-300 hover:bg-opacity-10 hover:backdrop-blur-sm hover:backdrop-filter hover:scale-150 hover:z-20 z-10
        shadow-lg rounded-md transition duration ease-in-out'>
            <div className='w-full h-full flex flex-col gap-4 hover:text-[#A6A78D] text-white'>
