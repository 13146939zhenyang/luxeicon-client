  ...
  return (
    <div className='w-[400px] h-auto'>
      <div className='w-full h-full flex flex-col gap-2'>
        <div className='w-full aspect-[2/1] bg-cover bg-right hover:aspect-[4/3] transition-all cursor-pointer duration-150 ease-in-out relative' style={{ backgroundImage: `url(${DemoWatch.src})` }}>
